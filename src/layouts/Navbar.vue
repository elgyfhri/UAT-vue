...
export default {
  ...
  methods: {
    ...
    async fetchProfileData() {
      try {
        ...
        const response = await axios.get(
          "https://pklwikrama1.4vmapps.com/users/profile",
          {
            headers: {
        ...
        if (this.profile.profile_image) {
          ...
          this.profile.photoUrl = `https://pklwikrama1.4vmapps.com/${this.profile.profile_image}`;
        }
    ...
    async handleLogout() {
      try {
        await axios.post(
          "https://pklwikrama1.4vmapps.com/logout",
          {},
          {
            headers: {
